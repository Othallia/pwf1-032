            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100 tracking-tight">Edit Category
                            </h2>
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Change the category name</p>
                        </div>
                    </div>
