                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h2 class="text-2xl font-bold text-gray-900 dark:text-gray-100 tracking-tight">Product</h2>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <form action="{{ route('product.delete', $product->id) }}" method="POST"
                                ...
                                @method('DELETE')
                                <button type="submit"
                                    class="inline-flex items-center gap-1.5 px-3 py-2 text-sm font-medium rounded-lg border border-red-200 dark:border-red-600 text-red-600 dark:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/30 transition">
                    ...
                    <div class="rounded-lg border border-gray-200 dark:border-gray-700 divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <div class="flex items-center px-5 py-4">
                            ...
                            <div class="flex items-center gap-2">
                                <div
                                    class="h-7 w-7 rounded-full bg-indigo-100 dark:bg-indigo-900/30 flex items-center justify-center text-indigo-600 dark:text-indigo-300 text-xs font-bold uppercase">
